...
{
    cout << "Importing reference solution data..." << endl
         << flush;
    ...
    printf("\033[F\033[J");
    cout << "Reading reference solution solver info..." << endl
         << flush;
    ...
    printf("\033[F\033[J");
    cout << "Reading reference solution statistics..." << endl
         << flush;
    ...
    printf("\033[F\033[J");
    cout << "Computing density distance area..." << endl
         << flush;
    ...
    printf("\033[F\033[J");
    cout << "Estimating self distances..." << endl
         << flush;
    ...
    cout << setfill('-') << setw(short_width / 2 - 2) << "-"
         << " Relative Error "
    ...
    cout << endl;
    cout << setfill('-') << setw(short_width / 2 - 6) << "-"
